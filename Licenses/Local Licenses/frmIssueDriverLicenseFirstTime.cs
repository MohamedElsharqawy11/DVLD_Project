...
namespace DVLD_Project
{
    public partial class frmIssueDriverLicenseFirstTime : Form
    {
        ...
        {
            int LicenseID = _LocalDrivingLicenseApplication.IssueLicenseForTheFirtTime(txtbxNotes.Text.Trim(), clsGlobal.CurrentUser.UserID);
            if (LicenseID != -1)
            {
        ...
        {
            _LocalDrivingLicenseApplication = clsLocalDrivingLicenseApplicationsB.FindByLocalDrivingAppLicense(_LocalDrivingLicenseAppID);
