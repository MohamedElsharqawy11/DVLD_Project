...
namespace DVLD_Project
{
    public partial class frmListTestsAppointments : Form
    {
        ...
        public frmListTestsAppointments(int localDrivingLicenseAppID, clsTestTypesB.enTestType TestType)
        {
            InitializeComponent();
        ...
        private void frmListTestsAppointments_Load(object sender, EventArgs e)
        {
            ...
            _dtAllTestAppointments = clsTestAppointmentB.GetApplicationTestAppointmentsPerTestType(_LocalDrivingLicenseAppID, _TestType);
            dgvAppointments.DataSource = _dtAllTestAppointments;
            lblRecordsApppsNums.Text = dgvAppointments.Rows.Count.ToString();
        ...
        {
            clsLocalDrivingLicenseApplicationsB localDrivingLicenseApplication = clsLocalDrivingLicenseApplicationsB.FindByLocalDrivingAppLicense(_LocalDrivingLicenseAppID);
            ...
            clsTestB LastTest = localDrivingLicenseApplication.GetLastTestPerTestType(_TestType);
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmScheduleTest frm = new frmScheduleTest(_LocalDrivingLicenseAppID, _TestType, TestAppointment);
            frm.ShowDialog();
            frmListTestsAppointments_Load(null, null);
        }
